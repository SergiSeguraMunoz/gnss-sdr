...
#ifndef GNSS_SDR_CHANNEL_LHCP_REFLECTOMETRY_H_
#define GNSS_SDR_CHANNEL_LHCP_REFLECTOMETRY_H_
 ...
 *
 */
class Channel_LHCP_Reflectometry : public ChannelInterface
{
public:
    //! Constructor
    Channel_LHCP_Reflectometry(ConfigurationInterface* configuration, uint32_t channel, std::shared_ptr<AcquisitionInterface> acq,
        std::shared_ptr<TrackingInterface> trk, std::shared_ptr<TelemetryDecoderInterface> nav,
        std::string role, std::string implementation, gr::msg_queue::sptr queue);

    virtual ~Channel_LHCP_Reflectometry();  //!< Virtual destructor
...
#endif  // GNSS_SDR_CHANNEL_LHCP_REFLECTOMETRY_H_
