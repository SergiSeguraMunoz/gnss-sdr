...
#ifndef GNSS_SDR_CHANNEL_LHCP_REFLECTOMETRY_OPEN_LOOP_PROCESSING_H_
#define GNSS_SDR_CHANNEL_LHCP_REFLECTOMETRY_OPEN_LOOP_PROCESSING_H_
...
class OpenLoopProcessingInterface;
 ...
 *
 */
class Channel_LHCP_Reflectometry_Open_Loop_Processing: public ChannelInterface
{

public:
    //! Constructor
    Channel_LHCP_Reflectometry_Open_Loop_Processing(ConfigurationInterface *configuration, unsigned int channel,
    ...
    //! Virtual destructor
    virtual ~Channel_LHCP_Reflectometry_Open_Loop_Processing();
    ...
    //! Returns "Channel_LHCP_Reflectometry"
...
private:
    ...
    std::shared_ptr<OpenLoopProcessingInterface> olp_;
    std::string role_;
...
#endif /*GNSS_SDR_CHANNEL_LHCP_REFLECTOMETRY_OPEN_LOOP_PROCESSING_H_*/
