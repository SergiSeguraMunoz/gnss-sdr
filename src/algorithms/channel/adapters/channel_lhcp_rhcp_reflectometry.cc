...
Channel_LHCP_RCHP_Reflectometry::Channel_LHCP_RCHP_Reflectometry(ConfigurationInterface* configuration, uint32_t channel, std::shared_ptr<AcquisitionInterface> acq,
...
Channel_LHCP_RCHP_Reflectometry::~Channel_LHCP_RCHP_Reflectometry() = default;


void Channel_LHCP_RCHP_Reflectometry::connect(gr::top_block_sptr top_block)
{
    if (!flag_enable_fpga)
        {
...
void Channel_LHCP_RCHP_Reflectometry::disconnect(gr::top_block_sptr top_block)
{
    if (!connected_)
        {
...
gr::basic_block_sptr Channel_LHCP_RCHP_Reflectometry::get_left_block()
{
...
gr::basic_block_sptr Channel_LHCP_RCHP_Reflectometry::get_left_block_trk()
{
    return trk_->get_left_block();
}


gr::basic_block_sptr Channel_LHCP_RCHP_Reflectometry::get_left_block_acq()
{
    if (flag_enable_fpga)
        {
...
gr::basic_block_sptr Channel_LHCP_RCHP_Reflectometry::get_right_block()
{
    return nav_->get_right_block();
}


void Channel_LHCP_RCHP_Reflectometry::set_signal(const Gnss_Signal& gnss_signal)
{
...
void Channel_LHCP_RCHP_Reflectometry::stop_channel()
{
    std::lock_guard<std::mutex> lk(mx);
...
void Channel_LHCP_RCHP_Reflectometry::start_acquisition()
{
    std::lock_guard<std::mutex> lk(mx);
    bool result = false;
    if (!flag_enable_fpga)
